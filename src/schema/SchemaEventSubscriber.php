...
class SchemaEventSubscriber implements EventSubscriber
{
    ...
    private function isMysqlPlatform($platform)
    {
    ...
    public function getCreateTableSQL($platform, $tableName, $columns, $options)
    {
    ...
    public function getIndexDeclarationSQL($platform, $name, Index $index)
    {
